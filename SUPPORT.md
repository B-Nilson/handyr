...
Thanks for using handyr! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/B-Nilson/handyr/issues/new).
...
requests](https://github.com/B-Nilson/handyr/issues) to make sure the
