...
This outlines how to propose a change to handyr. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("B-Nilson/handyr", fork = TRUE)`.
...
Please note that the handyr project is released with a [Contributor Code
of Conduct](https://b-nilson.github.io/handyr/CODE_OF_CONDUCT.md). By
